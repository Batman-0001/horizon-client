...
export default function Dashboard(props) {
  ...
  const getRoute = (pathname) => {
    return pathname !== '/admin/full-screen-maps';
  };
            ...
            <Portal>
              <Box>
                <Navbar
                  onOpen={onOpen}
                  logoText={'Horizon'}
                  brandText={getActiveRoute(routes, currentPath)}
                  secondary={getActiveNavbar(routes, currentPath)}
                  message={getActiveNavbarText(routes, currentPath)}
                  fixed={fixed}
                  {...rest}
                />
              </Box>
